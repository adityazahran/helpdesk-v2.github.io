<x-app-layout title="Cek Status Tiket">
  <div class="container min-h-screen mb-4">

    <div
      class="text-center mt-20 md:mt-8 mb-4 md:px-0 px-4 font-bold antialiased bg-clip-text text-transparent bg-gradient-to-r from-blue-300 to-blue-600">
    ...
    <section class="py-6">
      <div class="container">
        <table class="table-auto border w-full bg-white border-gray-400 overflow-x-auto whitespace-nowrap block">
                    ...
                    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-6 text-center">
                          ...
                          <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Tiket ini akan dihapus
                          </h3>

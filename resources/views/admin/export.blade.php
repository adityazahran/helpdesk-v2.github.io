<x-admin-layout>
    ...
    <form action="/admin/export" method="get">
      <input type="date" name="dari" value="{{ old('dari') }}"> Sampai <input type="date" name="sampai" id="" {{ old('sampai') }}>
      <button type="submit" class="py-2 px-4 bg-lime-300 hover:bg-lime-500 transition duration-150 text-white font-semibold rounded">Cek Tiket</button> 
    </form>
    <button method="get" href="/admin/export_">Export Ticket</button>

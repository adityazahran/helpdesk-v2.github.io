<x-admin-layout title="Admin Search">
        <div class="container min-h-screen mb-4">
      
          <div class="text-center mt-8 md:px-0 px-4 font-bold antialiased bg-clip-text text-transparent bg-gradient-to-r from-blue-300 to-blue-600">
            <h3 class="font-bold text-4xl">Cek Status Tiket</h3>
          </div>
      
          <section class="md:py-12 w-full mx-auto  md:w-5/12 rounded py-16 px-4">
      
            <form action="/admin/search" method="get" class="flex flex-1 flex-col justify-center space-y-2 md:space-y-4">

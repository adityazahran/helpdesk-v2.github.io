<x-app-layout>
    <div class="min-h-screen">
        <div class="container px-2">
            <section class="pt-16 pb-20 block md:flex bg-heroes">
                <div class="w-full md:w-1/2 antialiased flex flex-col justify-center mt-12">
                        ...
                        <div id="default-carousel" class="relative" data-carousel="static">
                            ...
                            <div class="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
                                ...
                                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                    ...
                                    <img src="/img/heroes.svg" alt="" srcset="" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" style="width: 400px"> 
                                </div>
                                <!-- Item 2 -->
                                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    ...
                    <h1 class="font-bold text-5xl md:text-left text-center">
                        PT Tirta Asasta
                    </h1>

                    <span class="font-medium md:font-semibold text-2xl md:text-left text-center">
                ...
                <div class="w-full md:w-1/2 gap-x-5 block md:flex px-4">
                    <a href="/ticket/create"
                        class="mt-20 border-2 space-y-6 text-center border-blue-500 bg-blue-500 hover:bg-blue-400 flex flex-col items-center transition-all duration-500  px-12 md:px-14 py-24 w-full md:w-1/2 rounded font-semibold text-white">
            ...
            <div class="flex justify-end justify-items-end">
                ...
                <div id="toast-success" class="flex items-center w-full max-w-xs p-4 mb-4 border border-gray-300 text-gray-500 bg-white rounded-lg shadow-2xl dark:text-gray-400 dark:bg-gray-800" role="alert">
